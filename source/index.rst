...
7. In **Configure FreeRADIUS Synchronization – Shared Secret**, type in a _`step` Shared Secret or click :guilabel:`Generate` to generate a random one (copy and save the shared secret to be used in)
